...
/* Generated : 03-Apr-2025 17:17:40 */
...
static const float P_ref_command_charge_Bat_p[] = { 1.3000f, 2.3000f, 3.0000f, 3.3000f };
static const float P_ref_command_discharge_Bat_p[] = { -3.3000f, -3.0000f, -2.3000f, -1.3000f };
...
void fis_EMS3inputs_init( void ){
    ...
    /* Set outputs */
    qFIS_OutputSetup( fis_EMS3inputs_outputs, P_ref_command, -3.5000f, 3.5000f );
