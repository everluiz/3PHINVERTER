...
/* Generated : 02-Apr-2024 17:07:59 */
...
static const float power_reference_Low_Deficit_p[] = { 430.0000f, -1500.0000f };
static const float power_reference_Low_Surplus_p[] = { 430.0000f, 1500.0000f };
static const float power_reference_Med_Surplus_p[] = { 0.0025f, 4000.0000f };
static const float power_reference_Balanced_p[] = { -50.0000f, 0.0000f, 50.0000f };
...
static const float V_sc_medium_p[] = { 195.0000f, 240.0000f, 310.0000f };
static const float V_sc_high_p[] = { 0.2461f, 320.0000f };
static const float P_ref_command_charge_SC_p[] = { 0.0000f, 0.3000f, 1.3000f, 2.3000f };
static const float P_ref_command_discharge_SC_p[] = { -2.3000f, -1.3000f, -0.3000f, 0.0000f };
...
void fis_EMS3inputs_init( void ){
    ...
    qFIS_SetMF( MFin, power_reference, power_reference_Low_Deficit, gaussmf, NULL, power_reference_Low_Deficit_p, 1.0f );
    qFIS_SetMF( MFin, power_reference, power_reference_Low_Surplus, gaussmf, NULL, power_reference_Low_Surplus_p, 1.0f );
